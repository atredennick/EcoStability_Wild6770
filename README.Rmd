...
*Note*: I've <span style="background-color: #FF7F7F">highlighted in red</span> some techical parts of the paper that you don't need to read.
...
4. Loreau and de Mazancourt's paper represents the contemporary view of how diversity can increase ecosystem stability.  
**How can Bai et al.'s results be placed within Loreau and de Mazancourt's framework?**
